...
Gem::Specification.new do |s|
  ...
  s.authors = ["Paul Gallagher".freeze, "Daniel Musekamp".freeze]
  s.date = "2018-08-11"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<pdf-reader>.freeze, ["~> 2.1"])
      ...
      s.add_development_dependency(%q<prawn>.freeze, ["~> 0.12"])
